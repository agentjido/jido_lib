defmodule Jido.Lib.Github.Agents.IssueTriageBotIntakeTest do
  ...
  test "parse_issue_url/1 parses valid github issue URL" do
    assert {"agentjido", "jido_chat", 19} =
             IssueTriageBot.parse_issue_url("https://github.com/agentjido/jido_chat/issues/19")
  end

  test "build_intake_attrs/5 builds canonical intake payload" do
    intake =
