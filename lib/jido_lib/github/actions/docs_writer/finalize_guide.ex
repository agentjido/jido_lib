defmodule Jido.Lib.Github.Actions.DocsWriter.FinalizeGuide do
  ...
  def run(params, _context) do
    ...
    final_guide = build_final_guide(params, decision)
  ...
  defp build_final_guide(params, :rejected) do
    ...
    ---
    <sub>Generated by Jido Documentation Writer Bot | Run ID: `#{params.run_id}`</sub>
    """
    |> String.trim()
  end

  defp build_final_guide(params, _decision) do
    draft =
      params[:writer_draft_v2] || params[:writer_draft_v1] ||
